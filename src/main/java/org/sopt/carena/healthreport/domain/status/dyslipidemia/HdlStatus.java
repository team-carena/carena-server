...
public enum HdlStatus implements HealthStatusCarrier {
	...
	HDL_BORDERLINE("HDL 수치 다소 낮음, 고밀도 콜레스테롤 수치 다소 낮음, 심혈관 보호 기능 감소 가능", RiskLevel.BORDERLINE),
	HDL_SUSPICIOUS("HDL 수치 낮음, 고밀도 콜레스테롤 수치 낮음, 심혈관 보호 기능 저하", RiskLevel.SUSPICIOUS);
