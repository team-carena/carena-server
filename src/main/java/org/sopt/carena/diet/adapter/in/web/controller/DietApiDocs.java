...
public interface DietApiDocs {
    @Operation(summary = "[ADMIN] 식단 정보 생성 " ,description = "[ADMIN] 식단 정보 생성을 위한 어드민 기능입니다.")
    ...
    ResponseEntity<SuccessResponse<DietDetailResponse>> dietDetail(String dietInformationId);
